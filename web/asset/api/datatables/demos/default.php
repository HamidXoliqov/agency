...
;
//$myPDO = new \PDO('pgsql:host=localhost;port=5432;dbname=demo_one', 'postgres', '123456');
//$result = $myPDO->query("SELECT * FROM bank")->fetchAll();
//$data = $alldata = json_decode(json_encode($result));
$data1 = json_decode(file_get_contents('../datasource/default.json'));
$data = $alldata = $data1;

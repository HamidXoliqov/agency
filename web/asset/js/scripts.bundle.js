				...
				setTimeout(function () {
					...
					if (hiddenExist) {
						...
						$(datatable.tableBody).find('.' + pfx + 'datatable-row').each(function() {
							...
							let th_head = $(datatable.tableHead).find(pfx + 'th');
							th_head.map(function(index, item){
...
KTUtil.ready(function() {
	...
	KTLayoutDemoPanel1.init('kt_demo_panel1');
...
var KTLayoutDemoPanel1 = function() {
    // Private properties
    var _element;
    var _offcanvasObject;
...
if (typeof module !== 'undefined') {
	...
	module.exports = KTLayoutDemoPanel1;
}

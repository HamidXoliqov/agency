...
/**
 * AppealTypeSearch represents the model behind the search form of `app\modules\manuals\models\AppealType`.
 */
class AppealTypeSearch extends AppealType
{
    /**
     * {@inheritdoc}
     */

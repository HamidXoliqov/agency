...
/* @var $searchModel app\modules\manuals\models\CountriesSearch */
            ...
            <?= GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'filter' => [
                            Countries::STATUS_ACTIVE => Yii::t('app', 'Active'),
                            Countries::STATUS_INACTIVE => Yii::t('app', 'Inactive'),
                        ],
                        'value' => static function ($model) {
                            if ($model['status'] === Countries::STATUS_ACTIVE) {
                                return "<span class='badge badge-info'>".Yii::t('app', 'Active')."</span>";
                            }

                            if ($model['status'] === Countries::STATUS_INACTIVE) {

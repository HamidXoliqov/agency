...
$this->title = Yii::t('app', 'Item models');
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Item references'), 'url' => ['item-references/index']];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="card card-custom">
    <div class="card-header flex-wrap border-0 pt-6 pb-0">
        <div class="card-title">
            <a href="<?= Url::to(['item-references/index']) ?>"
        ...
        <div class="card-toolbar">
            ...
            <!--end::Dropdown-->
            <!--begin::Button-->
            <button href="<?= Url::to(['item-references/item-references-create', 'id'=>$father]) ?>"
            ...
            <tbody>
                ...
                <?php foreach ($model as $key): ?>
                    <tr>
                        ...
                        <td><?= $key['sort'] ?></td>
                        <td><?php
                            if ($key['status'] === ItemReferences::STATUS_ACTIVE) {
                                echo $key['status'];
                            } else if ($key['status'] === ItemReferences::STATUS_INACTIVE) {
                                echo 2;
                            }
                            ?>
                        </td>
                        <td>
                            <a href="<?= Url::to(['item-references/item-references-update', 'id' => $key['id'], 'father' => $father]); ?>"
                               class="btn btn-icon btn-xs btn-outline-primary update-one">
                                <i class="la la-pencil-square-o"></i>
                            </a>
<!--                            <a href="--><?php //= Url::to(['view', 'id' => $key['id']]); ?><!--"-->
<!--                               class="btn btn-icon btn-xs btn-outline-info view-one">-->
<!--                                <i class="la la-eye"></i>-->
<!--                            </a>-->

                            <?= Html::a('<i class="la la-trash"></i>', ['item-references/delete', 'id' => $key['id']], [

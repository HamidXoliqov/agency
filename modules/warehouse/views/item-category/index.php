...
/* @var $item_categories_tree */

$this->title = Yii::t('app-msg', 'Item categories');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="card card-custom">
    <div class="card-body">
        <div class="card-body px-5" style="border-radius: 8px; border: 1px solid lightgrey; text-align: left">
            <button disabled class="btn btn-sm-button btn-outline-info add-tree save-parent" id="kt_quick_cart_toggle" href="<?=Url::to(['item-category/create'])?>">
                <i class="la la-plus ml-1"></i>
            </button>
            <button class="btn btn-sm-button btn-outline-success add-tree click_view" date-create="true" href="<?=Url::to(['item-category/create'])?>">
                <i class="la la-tree ml-1"></i>
            </button>
            <button disabled class="btn btn-sm-button btn-outline-danger delete-tree delete-parent"   href="<?=Url::to(['item-category/delete-ajax'])?>">
                <i class="la la-trash ml-1"></i>
            </button>
            <button disabled class="btn btn-sm-button btn-outline-primary update-parent" href="<?=Url::to(['item-category/update']) ?>">
                <i class="la la-pen ml-1"></i>
            </button>
            <br><br>
            <div id="kt_tree_1" class="tree-demo">
                <?=$item_categories_tree?>
            </div>
